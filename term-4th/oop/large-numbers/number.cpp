...
void Number::Init(string n) {
	num = n;
}

void Number::Init(Number n) {
	num = n.GetNumber();
}
...
string Number::GetSum(string num2) {
	if (num.size() > num2.size()) swap(num, num2);
...
string Number::GetDiff(string num2) {
	if (num.size() > num2.size()) swap(num, num2);
...
string Number::GetProduct(string num2) {
	string num1 = num;
	int n1 = num1.size(), n2 = num2.size();
